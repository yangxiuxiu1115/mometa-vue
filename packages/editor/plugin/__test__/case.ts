...
<template>
  <div :mometa="{ start: { column: 3, line: 8, offset: 107}, end: { column: 9, line: 16, offset: 406}, isSelfClosing: false}">
    <a :mometa="{ start: { column: 5, line: 9, offset: 117}, end: { column: 9, line: 12, offset: 269}, isSelfClosing: false}" href="https://vitejs.dev" target="_blank">
      <img :mometa="{ start: { column: 7, line: 10, offset: 169}, end: { column: 59, line: 10, offset: 221}, isSelfClosing: true}" src="/vite.svg" class="logo" alt="Vite logo" />
      <span :mometa="{ start: { column: 7, line: 11, offset: 228}, end: { column: 23, line: 11, offset: 244}, isSelfClosing: false}">asd</span><span :mometa="{ start: { column: 23, line: 11, offset: 244}, end: { column: 39, line: 11, offset: 260}, isSelfClosing: false}">asd</span>
    </a>
    <a :mometa="{ start: { column: 5, line: 13, offset: 274}, end: { column: 9, line: 15, offset: 397}, isSelfClosing: false}" href="https://vuejs.org/" target="_blank">
      <img :mometa="{ start: { column: 7, line: 14, offset: 326}, end: { column: 69, line: 14, offset: 388}, isSelfClosing: true}" src="./assets/vue.svg" class="logo vue" alt="Vue logo" />
    </a>
  </div>
  <span :mometa="{ start: { column: 3, line: 17, offset: 409}, end: { column: 59, line: 17, offset: 465}, isSelfClosing: false}" v-for="item in list" :key="item">{{ item }}</span>
</template>
